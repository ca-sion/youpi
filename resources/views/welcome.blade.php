    ...
    <div class="mx-auto max-w-4xl mb-10 mt-6 px-4">
        ...
        <section>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="grid mx-auto">
                    <a href="https://tiiva.ch/casion/calendar" class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
